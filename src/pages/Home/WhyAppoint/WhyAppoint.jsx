      ...
      <div className="flex gap-10 justify-between">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-2">
            <div className="space-y-2 shadow-sm p-5 rounded">
              ...
              <p className="opacity-65">
                At Interior Concepts & Design Limited we offer minimalistic
                design, luxurious design.
              </p>
            </div>
            <div className="space-y-2 shadow-sm p-5 rounded">
              ...
              <p className="opacity-65">
                We are ready to give you the best solution for your office or
                home interior.
              </p>
            </div>
            <div className="space-y-2 shadow-sm p-5 rounded">
              ...
              <p className="opacity-65">
                Interior Concepts & Design Limited saves your costs by helping
                you choose the best materials.
              </p>
            </div>
            <div className="space-y-2 shadow-sm p-5 rounded">
              ...
              <p className="opacity-65">
                We are committed to providing you the best and modern design
                interior.
              </p>
            </div>
          </div>
        ...
        <div className="flex-1">
          <iframe
            ...
            width="560"
            height="315"
            src="https://www.youtube.com/embed/6xSgcnrwZ2g?si=av87EiyEndtOpU2S"
