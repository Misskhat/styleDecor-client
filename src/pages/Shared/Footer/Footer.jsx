...
const Footer = () => {
    return (
        <div className='bg-base-200'>
            <footer className="footer sm:footer-horizontal w-11/12 mx-auto text-base-content py-7 px-2">
                <aside>
                    <Logo></Logo>
                    <p>
            ...
            <div className="footer sm:footer-horizontal footer-center bg-base-200 text-base-content p-4 border-t border-t-gray-300">
                <aside>
                    <p>Copyright © {new Date().getFullYear()} - All right reserved by <span className='font-semibold'>STYLEDECOR</span></p>
                </aside>
            </div>
        </div>
    );
